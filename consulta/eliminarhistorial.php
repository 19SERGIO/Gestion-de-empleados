...
if(isset($_POST['eliminar'])){
    ...
    $query = "DELETE FROM historial_laboral WHERE historial_laboral.his_id = '$id' ";
    $result = mysqli_query($conn, $query);
    ...
    if(!$result){
        ...
        echo '<script>
        setTimeout(function() {
            alert("historial_laboral eliminado con exito");
...
<body>
    <center>
        <div class="cuadro1">
            <div class="titulo">
                <h2>Eliminar Historial Laboral</h2>
                <hr>
            </div>
            <form action="../consulta/eliminarhistorial.php" method="POST">
                <div class="consulta">
                ...
                <div class="info">
                    <input type="text" id="pue" name="pue" value="<?php echo $pue; ?>" placeholder="Id del puesto">
                    <input type="text" id="emp" name="emp" value="<?php echo $emp; ?>" placeholder="Apellido"><br>
                    <input type="text" id="fi" name="fi" value="<?php echo $fi; ?>" placeholder="Id del departamento">
                    <input type="text" id="ff" name="ff" value="<?php echo $ff; ?>" placeholder="Dirección"><br>
